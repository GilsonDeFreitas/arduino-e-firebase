...
#define FIREBASE_AUTH "Chave_Secreta"
...
void loop()
{
  ...
  if ((ultimotempoClima == 0) || ( (millis() - ultimotempoClima) >= tempoClima)) {
    ...
    Firebase.setFloat("C118_TEM_J1",WC118_TEM_J1);
  ...
  if ((ultimotempoLuzes == 0) || ( (millis() - ultimotempoLuzes) >= tempoLuzes)) {
    ...
    WLUZ = Firebase.getInt("C118_LUZ_TODAS");
    ...
    if (WLUZ == 2){
      ...
      WLUZ = Firebase.getInt("C118_LUZ_Q2");
      // Se o o valor desta luz local for diferente do valor lido do firebase
      ...
      WLUZ = Firebase.getInt("C118_LUZ_B1");
      // Se o o valor desta luz local for diferente do valor lido do firebase
      ...
      WLUZ = Firebase.getInt("C118_LUZ_S1");
      // Se o o valor desta luz local for diferente do valor lido do firebase
      ...
      WLUZ = Firebase.getInt("C118_LUZ_C1");
      // Se o o valor desta luz local for diferente do valor lido do firebase
      ...
      WLUZ = Firebase.getInt("C118_LUZ_J1");
      // Se o o valor desta luz local for diferente do valor lido do firebase
  ...
  */
  if (WC118_POR_S1 != digitalRead(PC118_POR_S1))
  {
    ...
    Firebase.setInt("C118_POR_S1",WC118_POR_S1);
    delay(500);// aguarda 0.5 segundo para evitar de variar o valor
  ...
  if (WC118_POR_C1 != digitalRead(PC118_POR_C1))
  {
    ...
    Firebase.setInt("C118_POR_C1",WC118_POR_C1);
    delay(500);// aguarda 0.5 segundo para evitar de variar o valor
